        ...
        <div>
            <div class="row">
                <div class="col-md-10">
                    ...
                    @endif
                    <form method="post" id="article_details_form" action="{{route('store_area_of_focus')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group article_content_holder">
                            ...
                            <textarea id="content" name="content" class="form-control mb-4"></textarea>
                            ...
                            <div class="col-md-12 mt-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <button class="btn btn-success btn-sm btn-flat custom_button add_sub_service" id="add_sub_service"> Add a Sub-Service</button>
                                </div>
                                <br><br>
                            </div>

                            {{-- <textarea id="teaser" name="article_content" >{{$resource->article_content}}</textarea> --}}
                            <button type="submit" class="ml-2 btn btn-success btn-sm btn-flat custom_button custom_button_width tiny_mce_submits" id="btn_save_draft"> &nbsp; &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp; Save  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;</button>
