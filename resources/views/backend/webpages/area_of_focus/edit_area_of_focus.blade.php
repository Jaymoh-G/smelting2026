        ...
        <div>
            <div class="row">
                <div class="col-md-10">
                    ...
                    @endif
                    <form method="post" id="article_details_form" action="{{route('update_area_of_focus')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group article_content_holder">
                            ...
                            <label for="title" class="mt-4">Description</label>
                                ...
                                <div>
                                    ...
                                    <div id="sub_services_holder">
                                        @foreach($sub_services as $sub_service)
                                            <div class="mb-4"> <input type="text" value="{{$sub_service->title}}" class="form-control" name="sub_service[]" required style="display:inline; width: 89%"> <button class="btn btn-sm btn-danger btn-flat btn-inline remove_subservice" > Remove <i class="fa fa-trash"></i> </button></div>
                                        @endforeach
                                    </div>
                                    <button class="btn btn-success btn-sm btn-flat custom_button custom_button add_sub_service" id="add_sub_service"> Add a Sub-Service</button>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#add_sub_service').on('click', function(e){
                ...
                $('#sub_services_holder').append('<div class="mb-4"> <input type="text" class="form-control" name="sub_service[]" required style="display:inline; width: 89%"> <button class="btn btn-sm btn-danger btn-flat btn-inline remove_subservice"> Remove <i class="fa fa-trash"></i> </button></div>');
            });
