        ...
        <div>
            <div class="row">
                <div class="col-md-10">
                    ...
                    @endif
                    <form method="post" id="article_details_form" action="{{route('store_blog')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group article_content_holder">
                            ...
                            <textarea id="teaser" name="teaser" class="form-control mb-4"></textarea>
