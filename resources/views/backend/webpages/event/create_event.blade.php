        ...
        <div>
            <div class="row">
                <div class="col-md-10">
                    ...
                    @endif
                    <form method="post" id="article_details_form" action="{{route('store_event')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group article_content_holder">
                            ...
                            <input type="text" class="form-control mb-4" name="location" id="location" required>
							...
							<div class="price-holder" id="priceHolder">
								...
								<input type="number" class="form-control mb-4" name="cost" id="cost" value="" required>
							</div>

                            <label for="description">Description</label>
                            <textarea id="description" name="description" class="form-control mb-4"></textarea>
    ...
    <script>
        ...
        $('.pricing-mode').on('change', function(){
            ...
            $('#add_sub_service').on('click', function(e){
                ...
                $('#sub_services_holder').append(`
                <div class="mb-4" id="extra${$i}"> 
                    ...
                    <br>
                    <input type="text" class="form-control" name="value_of_field[]" 
                        required style="display:inline; width: 89%"> 
