        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col -md-12">
                    ...
                    <a class="btn btn-success btn-sm" href="{{ route('event_regs_index') }}">
                        Events List
                        <i class="fa fa-backward"></i>
                    </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="main_grid" class="table table-striped table-bordered table-hover table-condensed"
                        cellspacing="0" width="100%" style="overflow-x:hidden">
                        <thead>
                            <tr class="success">
                                {{-- <th>T</th> --}}
                                <th>F.Name</th>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var reg_id = url.split("/")[4];

            var str = "/admin/event/registrations/" + reg_id;
            ...
            dataTable = $('#main_grid').DataTable({
                ...
                language: {
                    "search": "",
                    "emptyTable": "There is no registrations for this event yet."
                },
