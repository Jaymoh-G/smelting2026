        ...
        <div class="about-inner">
            <div class="wrapper">
                ...
                <ul class="breadcrumbs-custom-path">
                    ...
                    <li class="active">{{$blog_item->title}}</li>
                </ul>
            </div>
        </div>
    </section>
            ...
            <div class="wrapper">
                ...
                <div class="single-left">
                    <div class="single-left1 box13">
                        ...
                        <img class="side-img" style="max-height: 400px; width: auto;"
                            src="{{asset('images/blog_images/'.$blog_item->image_url)}}" 
                            alt="Blog Image" />

                        <h3 class="card-title"> {{$blog_item->title}} </h3>
                        <ul class="admin-list">
                            <li>
                                <a href="#">
                                    <span class="fa fa-calendar" aria-hidden="true"></span>
                                    {{$blog_item->date_published}}
                                </a>
                                </li>
                        ...
                        <p class="">{!! $blog_item->teaser !!} </p>


                        <p class="">{!! $blog_item->content !!}</p>
                    </div>
